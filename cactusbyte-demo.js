/* Cactus🌵Byte Studios™ — Demo & Help Standard v1.1
   Timed in-app demo player. No service worker. No autoplay audio. */
(function(){
  ...
  function mockup(kind){
    if(kind==='capture')return '<div class="cbs-mock"><div class="cbs-mock-action">SNAP ITEM</div><div class="cbs-mock-evidence"><span class="cbs-mock-pill">Camera</span><span class="cbs-mock-pill">Add photos</span><span class="cbs-mock-pill">Auto analysis</span></div></div>';
    if(kind==='scan')return '<div class="cbs-mock"><div class="cbs-mock-action">IDENTIFYING ITEM · CHECKING MARKET</div><div class="cbs-mock-evidence"><span class="cbs-mock-pill">Brand</span><span class="cbs-mock-pill">Model</span><span class="cbs-mock-pill">Condition</span><span class="cbs-mock-pill">Sold evidence</span></div></div>';
    if(kind==='prices')return '<div class="cbs-mock cbs-mock-row"><div class="cbs-mock-card"><small>LIST IT</small><b>$145</b></div><div class="cbs-mock-card"><small>EXPECT</small><b>$125</b></div><div class="cbs-mock-card"><small>SELL FAST</small><b>$105</b></div><div class="cbs-mock-card"><small>MAX BUY</small><b>$68</b></div></div>';
    if(kind==='decision')return '<div class="cbs-mock"><div class="cbs-mock-action">BUY AT OR BELOW $68</div><div class="cbs-mock-row"><div class="cbs-mock-card"><small>TARGET PROFIT</small><b>$35</b></div><div class="cbs-mock-card"><small>BEST MARKET</small><b>eBay</b></div></div></div>';
    if(kind==='evidence')return '<div class="cbs-mock"><div class="cbs-mock-evidence"><span class="cbs-mock-pill">Identity confidence: High</span><span class="cbs-mock-pill">Condition: Good</span><span class="cbs-mock-pill">Comparable sales</span><span class="cbs-mock-pill">Source links</span></div></div>';
    if(kind==='listing')return '<div class="cbs-mock"><div class="cbs-mock-card"><small>READY-TO-LIST COPY</small><b>Title + price + description</b></div><div class="cbs-mock-action">COPY LISTING · OPEN MARKETPLACE</div></div>';
    return '<div class="cbs-mock"><div class="cbs-mock-action">SNAP IT · PRICE IT · DECIDE</div></div>';
  }
